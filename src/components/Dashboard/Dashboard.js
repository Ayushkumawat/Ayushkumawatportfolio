          ...
          <AnimatePresence>
            ...
            >
              {[
                {
                  id: 'repo-activity',
                  chart: <GitHubStats showChart={true} showSummary={false} />,
                  title: 'Repository Activity',
                },
                {
                  id: 'language-dist',
                  chart: <GitHubLanguages />, title: 'Language Distribution',
                },
                {
                  id: 'contrib-history',
                ...
                {
                  id: 'new-chart-1',
                  chart: <RepoCreationChart />, title: 'Repos by Creation Date',
                },
                {
                  id: 'new-chart-2',
                  chart: <GitHubContributions />, title: 'Contribution History',
                },
              ].map((card, i) => (
                <motion.div
